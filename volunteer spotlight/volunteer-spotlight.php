...
function vsp_register_post_type() {
    ...
    // Register custom image size for volunteer spotlight images (800x600 cropped/cover)
    add_image_size('volunteer_spotlight_thumb', 800, 600, true);
}
...
.vsp-swiper{padding-bottom:50px!important;overflow:hidden!important}
...
.vsp-card-inner{display:flex!important;flex-direction:row!important;min-height:350px!important;height:350px!important}
...
.vsp-card-photo{position:relative!important;flex:0 0 45%!important;max-width:45%!important;height:100%!important;overflow:hidden!important;border-radius:var(--vsp-card-radius) 0 0 var(--vsp-card-radius)!important}
.vsp-card-photo img{position:absolute!important;top:0!important;left:0!important;width:100%!important;height:100%!important;object-fit:cover!important;display:block!important;transition:transform .5s ease!important}
.vsp-card:hover .vsp-card-photo img{transform:scale(1.05)!important}
.vsp-photo-placeholder{position:absolute!important;top:0!important;left:0!important;width:100%!important;height:100%!important;display:flex!important;align-items:center!important;justify-content:center!important;background:var(--vsp-gray-light)!important;color:#ccc!important}
.vsp-photo-placeholder svg{width:80px!important;height:80px!important}
...
.vsp-nav-container{display:flex!important;align-items:center!important;justify-content:center!important;gap:20px!important;margin-top:15px!important}
.vsp-swiper .swiper-button-prev,.vsp-swiper .swiper-button-next{position:static!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;width:44px!important;height:44px!important;background:var(--vsp-white)!important;border:2px solid var(--vsp-red)!important;border-radius:50%!important;color:var(--vsp-red)!important;transition:all .3s ease!important;margin:0!important;top:auto!important;bottom:auto!important;left:auto!important;right:auto!important}
.vsp-swiper .swiper-button-prev:hover,.vsp-swiper .swiper-button-next:hover{background:var(--vsp-red)!important;color:var(--vsp-white)!important}
.vsp-swiper .swiper-button-prev::after,.vsp-swiper .swiper-button-next::after{font-size:16px!important;font-weight:bold!important}
.vsp-swiper .swiper-pagination{position:static!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;width:auto!important;gap:8px!important;margin:0!important}
.vsp-swiper .swiper-pagination-bullet{width:10px!important;height:10px!important;background:#ddd!important;opacity:1!important;transition:all .3s ease!important}
.vsp-swiper .swiper-pagination-bullet-active{background:var(--vsp-red)!important;width:28px!important;border-radius:5px!important}
...
@media(max-width:768px){.vsp-card-inner{flex-direction:column!important;height:auto!important;min-height:auto!important}.vsp-card-photo{flex:none!important;max-width:100%!important;height:280px!important;min-height:280px!important}.vsp-card-content{padding:24px 20px!important}.vsp-name{font-size:22px!important}.vsp-designation{font-size:14px!important}.vsp-description{-webkit-line-clamp:4!important}.vsp-decor-dots{display:none!important}.vsp-slider-wrapper{padding:10px 5px!important;margin:20px auto!important}}
@media(max-width:480px){.vsp-card-photo{height:220px!important;min-height:220px!important}.vsp-card-content{padding:20px 16px!important}.vsp-name{font-size:20px!important}.vsp-badge{font-size:11px!important;padding:5px 12px!important}.vsp-read-more{padding:8px 18px!important;font-size:13px!important}.vsp-swiper .swiper-button-prev,.vsp-swiper .swiper-button-next{width:36px!important;height:36px!important}.vsp-swiper .swiper-button-prev::after,.vsp-swiper .swiper-button-next::after{font-size:13px!important}}
';
}
        ...
        <div class="swiper vsp-swiper">
            <div class="swiper-wrapper">
                <?php while ($query->have_posts()) : $query->the_post(); 
                    ...
                    $photo_url   = get_the_post_thumbnail_url(get_the_ID(), 'volunteer_spotlight_thumb');
                    $name        = get_the_title();
                ?>
                    ...
                    <div class="vsp-card">
                        ...
                        <div class="vsp-card-inner">
                            ...
                            <div class="vsp-card-photo">
                                <?php if ($photo_url) : ?>
                                    <img src="<?php echo esc_url($photo_url); ?>" alt="<?php echo esc_attr($name); ?>" width="800" height="600" loading="lazy" />
                                <?php else : ?>
